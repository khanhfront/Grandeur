...
export default function SearchComponent() {
  ...
  return (
    <div className="hidden md:flex w-full md:w-1/2 justify-between items-center rounded-full bg-secondary p-1 px-2 gap-2">
      <div className="flex w-3/4 justify-between items-center gap-2">
        ...
        <Popover>
          <PopoverTrigger asChild>
            <Button
              variant="outline"
              className="hidden min-[250px]:block w-1/4 md:w-auto rounded-full bg-transparent border-0 md:flex items-center"
            >
